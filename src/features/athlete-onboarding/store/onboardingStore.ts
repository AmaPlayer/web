    ...
    (set, get) => ({
      ...
      saveProfile: async (userId?: string) => {
        ...
        try {
          ...
          console.log('Saving athlete profile to Firebase:', profileData);
          ...
          console.log('✅ Athlete profile saved successfully:', savedProfile);
          
          // Also save to localStorage as backup
          try {
            localStorage.setItem('athlete-profile', JSON.stringify(savedProfile));
            console.log('Athlete profile backed up to localStorage');
          } catch (storageError) {
      ...
      loadProfile: async (userId: string) => {
        try {
          ...
          console.log('Loading athlete profile from Firebase for user:', userId);
          
          // Load from Firebase
          const profile = await athleteProfileService.getAthleteProfile(userId);
          
          if (profile) {
            console.log('✅ Athlete profile loaded successfully:', profile);
            ...
            console.log('No athlete profile found for user:', userId);
          ...
          try {
            ...
            if (localProfile) {
              ...
              console.log('Loaded athlete profile from localStorage fallback:', parsedProfile);
