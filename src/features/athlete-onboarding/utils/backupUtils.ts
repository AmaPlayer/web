...
export const createOnboardingBackup = (
  ...
  try {
    ...
    console.log('Onboarding backup created successfully:', backup);
    return true;
  } catch (error) {
...
export const restoreOnboardingFromBackup = (backup: OnboardingBackup): boolean => {
  try {
    ...
    console.log('Restoring onboarding from backup:', backup);
    return true;
  } catch (error) {
...
export const clearOnboardingBackups = (): boolean => {
  try {
    ...
    console.log('All onboarding backups cleared');
    return true;
  } catch (error) {
...
export const attemptOnboardingRecovery = (): OnboardingBackup | null => {
  try {
    ...
    console.log('Recovery backup found:', getBackupDescription(latestBackup));
    return latestBackup;
  } catch (error) {
