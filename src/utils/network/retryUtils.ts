  ...
  return retryOperation(operation, {
    ...
    retryCondition: (error: any) => {
      ...
      if (error?.code) {
        ...
        if (shouldRetry) {
          console.log(`🔄 ${operationName} will be retried due to Firebase error:`, error.code);
        } else {
          console.log(`🚫 ${operationName} will not be retried due to Firebase error:`, error.code);
        }
